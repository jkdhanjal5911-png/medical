				...
				<div class="col-lg-3 col-md-3 col-sm-3">
					<div class=" single-footer-widget ">
						...
						<address class="contact-info">
							...
							<p><span class="fa fa-phone"></span>6280671186</p>
							<p><span class="fa fa-envelope"></span>JKdhanjal.com</p>
						</address>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="footer-copyright">
						<?= "<p>&copy; Copyright 2016-" . date("Y") . " <a href=\"index.html\">SPA Pathcare</a></p>"; ?>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
