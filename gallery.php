					...
					<div class="gallery-area">
						...
						<div class="my-simple-gallery">
							...
							<div class="row">
								...
								<figure itemprop="associatedMedia" class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
									<a class="gallery-iteam" href="images/gallery/HCNOCTN442-IMS-en_AA.png" itemprop="contentUrl"
										data-size="1024x683">
								...
								<figure itemprop="associatedMedia" class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
									<a class="gallery-iteam" href="images/gallery/istock_000014368289small.jpg" itemprop="contentUrl"
										data-size="1024x1024">
								...
								<figure itemprop="associatedMedia" class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
									<a class="gallery-iteam" href="images/gallery/new-banner-slp-video1.jpg" itemprop="contentUrl"
										data-size="1024x683">
						...
						<div class="my-simple-gallery">
							...
							<div class="row">
								...
								<figure itemprop="associatedMedia" class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
									<a class="gallery-iteam" href="images/gallery/cb-spa-resources.jpg" itemprop="contentUrl"
										data-size="1024x1024">
								...
								<figure itemprop="associatedMedia" class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
									<a class="gallery-iteam" href="images/gallery/eservice_Diagnosis__Pathology_Pic_1.jpg"
										...
										<img src="images/gallery/eservice_Diagnosis__Pathology_Pic_1.jpg" itemprop="thumbnail"
											alt="Image description" />
										<span class="image-effect"></span>
									</a>
								</figure>
								<figure itemprop="associatedMedia" class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
									<a class="gallery-iteam" href="images/gallery/pediatric-pathology.jpg" itemprop="contentUrl"
										data-size="1024x768">
								...
								<figure itemprop="associatedMedia" class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
									<a class="gallery-iteam" href="images/gallery/DepartmentofPathology2013-2014-Feature-edit.jpg"
										itemprop="contentUrl" data-size="1024x768">
										<img src="images/gallery/DepartmentofPathology2013-2014-Feature-edit.jpg" itemprop="thumbnail"
											alt="Image description" />
										<span class="image-effect"></span>
									</a>
								</figure>
