											...
											<tbody>
												...
												while ($row = mysqli_fetch_array($sql)) {
													...
													<tr>
														...
														<td><a href="delete.php?data=test&id=<?= $row['id']; ?>">Delete</a>
														</td>
													</tr>
													<?php
												}
							...
							<div class="service-content">
								<div class="row">
									<div class="col-lg-12 col-md-12">
											...
											<tbody>
												...
												while ($row = mysqli_fetch_array($sql)) {
													...
													<tr>
														...
														<td><a href="edit.php?data=doctor&id=<?= $row['id']; ?>">Edit</a>
														</td>
														<td><a href="delete.php?data=doctor&id=<?= $row['id']; ?>">Delete</a>
														</td>
													</tr>
													<?php
												}
										...
										<div class="readmore_area">
											<a data-hover="Add New" href="insert.php?data=doctor"><span>Add
													New</span></a>
										</div>
									</div>
								</div>
